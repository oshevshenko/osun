...
array( "name" => "tab_content_1",
  ...
  array( "type" => "infotext",
		"name" => __( 'If you would like to purchase the NatureSpace Premium Version, you can do so on <a href="http://www.tomastoman.cz/downloads/naturespace/" target="_blank">Developers Official Website</a>.' , 'naturespace' )),
...
?>
	...
	<div id="wrap_fm"><!-- [ Header ]-->
		...
		<div class="top_menu_fm">
			<a target="_blank" class="doc_fm" href="<?php echo esc_url($naturespace_manualurl); ?>"><?php _e( 'Documentation' , 'naturespace' ); ?></a><a target="_blank" class="support_fm" href="http://www.tomastoman.cz/support"><?php _e( 'Support' , 'naturespace' ); ?></a><a target="_blank" class="premium_fm" href="http://www.tomastoman.cz/downloads/naturespace/"><?php _e( 'Get Premium Version' , 'naturespace' ); ?></a>
		</div>
